...
// Vitest is used purely as a Vite-aware runner — there are no real assertions.
...
const ownerId = 'b67dbb45-3d26-436a-9a15-ad96f635c26e';
const nameById = new Map(persons.map((p) => [p.id, p.firstName]));

test('debug — production tree layout', () => {
