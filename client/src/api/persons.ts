...
export interface CreatePersonInput { firstName: string; lastName?: string; middleName?: string; maidenName?: string; gender: 'male' | 'female'; birthYear?: number; birthDate?: string; birthDateKnown?: boolean; isAlive?: boolean; deathYear?: number; deathDate?: string; deathDateKnown?: boolean; note?: string; phone?: string; address?: string; maritalStatus?: string; relationships?: { category: 'couple' | 'parent_child'; otherPersonId: string; role?: 'parent' | 'child' | 'spouse'; coupleStatus?: string; childRelation?: string }[]; }
